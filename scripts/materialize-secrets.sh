...
umask 077
{
  ...
  for pair in PERPLEXITY_API_KEY:PERPLEXITY_API_KEY_REF X_BEARER_TOKEN:X_BEARER_TOKEN_REF MINIMAX_API_KEY:MINIMAX_API_KEY_REF MINIMAX_SUBSCRIPTION_KEY:MINIMAX_SUBSCRIPTION_KEY_REF DOUBAO_API_KEY:DOUBAO_API_KEY_REF OPENAI_API_KEY:OPENAI_API_KEY_REF MOONSHOT_API_KEY:MOONSHOT_API_KEY_REF GEMINI_API_KEY:GEMINI_API_KEY_REF API_MONITOR_KEY:API_MONITOR_KEY_REF GITHUB_TOKEN:GITHUB_TOKEN_REF SEMANTIC_SCHOLAR_API_KEY:SEMANTIC_SCHOLAR_API_KEY_REF CLOUDFLARE_API_TOKEN:CLOUDFLARE_API_TOKEN_REF CLOUDFLARE_ACCOUNT_ID:CLOUDFLARE_ACCOUNT_ID_REF GODADDY_API_TOKEN:GODADDY_API_TOKEN_REF GODADDY_ACCOUNT_ID:GODADDY_ACCOUNT_ID_REF ENS_RPC_URL:ENS_RPC_URL_REF; do
